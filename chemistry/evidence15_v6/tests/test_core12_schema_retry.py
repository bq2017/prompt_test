...
from chemistry_core12_schema import (
    Core12SchemaError,
...
RUNNER_PATH = PACKAGE_ROOT / "src" / "chemistry_difficulty_rating_0730_v5_2_evidence15_v6_with_cache.py"
...
def load_runner():
    spec = importlib.util.spec_from_file_location("core12_production_runner", RUNNER_PATH)
...
class Core12SchemaTests(unittest.TestCase):
    ...
    def test_legal_output_passes_without_level_change(self) -> None:
        ...
        self.assertEqual(prepared["postprocess_profile"], "core12_schema_only")
    ...
    def test_image_primary_defaults_and_prompt_path_are_safe(self) -> None:
        ...
        self.assertEqual(RUNNER.DEFAULT_PROMPT, PACKAGE_ROOT / "prompts" / "0730初中化学难度打标提示词_v5_2_evidence15_v6.txt")
    ...
    async def run_process(self, sequence, *, schema_retries=2, json_retries=2):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                ...
                patch.object(RUNNER, "CORE12_POSTPROCESS_PROFILE", "core12_schema_only"),
            ):
